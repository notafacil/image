...
namespace NotafacilAPI\Image\Entity;

use ZF\OAuth2\Doctrine\Entity\UserInterface as ZFOAuth2DoctrineUserInterface;
use Zend\Stdlib\ArraySerializableInterface;
use Doctrine\Common\Collections\ArrayCollection;

class User implements ZFOAuth2DoctrineUserInterface, ArraySerializableInterface
{
    protected $id;
    protected $client;
    protected $images;
     ...
     * Add image
     *
     * @param  NotafacilAPI\Image\Entity\Image $image
     */
