<?php
namespace NotafacilAPI\Image\Service;
...
use NotafacilAPI\Image\Entity\Image as ImageEntity;
use NotafacilAPI\Image\Mapper\ImageInterface as ImageMapperInterface;
...
class Image implements ServiceLocatorAwareInterface
{
    ...
    /**
     * @var \NotafacilAPI\Image\Entity\User
     */
    protected $user;

    /**
     * @var \NotafacilAPI\Image\Entity\ImageEntityInterface
     */
    protected $entity;
    ...
    /**
     * @var \NotafacilAPI\Image\Mapper\ImageInterface
     */
    protected $mapper;
    ...
    {
        $mapper   = $this->getServiceLocator()->get('NotafacilAPI\\Image\\Mapper\\Image');
    ...
    {
        if ($this->mapper === null) {
            $this->setMapper($this->getServiceLocator()->get('NotafacilAPI\\Image\\Mapper\\Image'));
        }
     ...
     * Set Mapper
     * 
     * @param NotafacilAPI\Image\Mapper\ImageInterface $mapper
     */
