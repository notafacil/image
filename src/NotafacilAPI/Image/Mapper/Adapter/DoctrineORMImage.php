...
namespace NotafacilAPI\Image\Mapper\Adapter;
...
class DoctrineORMImage implements ImageMapperInterface, ServiceLocatorAwareInterface
{
    ...
    public function getHydrator()
    {
        if ($this->hydrator === null) {
            ...
            $this->setHydrator($hydratorManager->get('NotafacilAPI\\Image\\Entity\\Hydrator'));
        }
    ...
    {
        return $this->getEntityManager()->getRepository('NotafacilAPI\Image\Entity\Image');
    }
}
