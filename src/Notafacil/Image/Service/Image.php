<?php
namespace Notafacil\Image\Service;
...
use Notafacil\Image\Entity\ImageInterface as ImageEntityInterface;
use Notafacil\Image\Entity\Image as ImageEntity;
use Notafacil\Image\Mapper\ImageInterface as ImageMapperInterface;
...
class Image implements ServiceLocatorAwareInterface
{
    ...
    /**
     * @var \Notafacil\Image\Entity\User
     */
    protected $user;

    /**
     * @var \Notafacil\Image\Entity\ImageEntityInterface
     */
    protected $entity;
    ...
    /**
     * @var \Notafacil\Image\Mapper\ImageInterface
     */
    protected $mapper;
    ...
    {
        $mapper   = $this->getServiceLocator()->get('Notafacil\\Image\\Mapper\\Image');
    ...
    {
        if ($this->mapper === null) {
            $this->setMapper($this->getServiceLocator()->get('Notafacil\\Image\\Mapper\\Image'));
        }
     ...
     * Set Mapper
     * 
     * @param Notafacil\Image\Mapper\ImageInterface $mapper
     */
