...
namespace Notafacil\Image\V1\Rest\Image;

use ZF\ApiProblem\ApiProblem;
use Notafacil\Image\V1\Rest\AbstractResourceListener;
use Notafacil\Image\Event as ImageEvent;
...
class ImageResource extends AbstractResourceListener
{
     ...
     * Get Mapper
     *
     * @return Notafacil\\Image\Mapper\ImageMapperInterface
     */
    protected function getMapper()
    {
        return $this->getServiceLocator()->get('Notafacil\\Image\\Mapper\\Image');
    }
}
