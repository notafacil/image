...
class Module implements ApigilityProviderInterface
{
    public function onBootstrap(MvcEvent $mvcEvent)
    {
        ...
        $sharedEventManager->attachAggregate($serviceManager->get('Notafacil\\Image\\SharedEventListener'));
        ...
        $eventManager->attach(
            ...
            $serviceManager->get('Notafacil\\Image\\Authorization\\AclScopeListener'),
            101
        );
        // anexar (incorporar) ACL para verificar proprietário da imagem
        $eventManager->attach(
            MvcAuthEvent::EVENT_AUTHORIZATION_POST,
            $serviceManager->get('Notafacil\\Image\\Authorization\\AclImageListener'),
            100
        );
    }
