...
use Notafacil\Image\Mapper\UserInterface as UserMapperInterface;
use Notafacil\Image\Entity\UserInterface as UserEntityInterface;
...
class DoctrineORMUser implements UserMapperInterface, ServiceLocatorAwareInterface
{
    ...
    {
        return $this->getEntityManager()->getRepository('Notafacil\\Image\\Entity\\User');
    }
}
