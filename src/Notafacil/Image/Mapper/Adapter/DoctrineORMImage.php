...
namespace Notafacil\Image\Mapper\Adapter;
...
class DoctrineORMImage implements ImageMapperInterface, ServiceLocatorAwareInterface
{
    ...
    public function getHydrator()
    {
        if ($this->hydrator === null) {
            ...
            $this->setHydrator($hydratorManager->get('Notafacil\\Image\\Entity\\Hydrator'));
        }
    ...
    {
        return $this->getEntityManager()->getRepository('Notafacil\Image\Entity\Image');
    }
}
